...
describe('ConversationView session boot', () => {
  ...
  it('does not auto-init idle sessions when only viewing history', async () => {
    ...
    expect(storeState.initProcess).not.toHaveBeenCalled()
  })

  it('still auto-inits running sessions so live output can resume', async () => {
