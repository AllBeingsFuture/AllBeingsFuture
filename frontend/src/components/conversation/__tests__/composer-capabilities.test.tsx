...
describe('ComposerCapabilities', () => {
  ...
  it('opens the capability menu from the + button and opens skills picker', async () => {
    renderWithProviders(<ComposerCapabilities onAttachFiles={vi.fn()} />)
  ...
  it('invokes attach handler from the + menu', () => {
    const onAttachFiles = vi.fn()
    renderWithProviders(<ComposerCapabilities onAttachFiles={onAttachFiles} />)
