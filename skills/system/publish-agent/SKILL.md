---
name: publish-agent
description: Publish a local Agent to the AllBeingsFuture Platform Agent Store. Package and prepare a local Agent for publishing to the community hub.
version: 1.0.0
...
Publish a local Agent to the AllBeingsFuture Platform Agent Store.
...
- Publish an Agent to the AllBeingsFuture hub
