...
description: Search for Skills on the AllBeingsFuture Platform Skill Store
system: true
handler: skill_store
...
Search for Skills on the AllBeingsFuture Platform Skill Store.

## When to Use

- User wants to find or browse Skills on the AllBeingsFuture marketplace
...
- **official**: Maintained by the AllBeingsFuture team
