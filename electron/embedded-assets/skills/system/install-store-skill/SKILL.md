...
description: Install a Skill from the AllBeingsFuture Platform Skill Store
system: true
handler: skill_store
...
Install a Skill from the AllBeingsFuture Platform Skill Store to the local system.
